...
<?php include "fe_head.php"; ?>
  <body class="hold-transition skin-<?php echo fe_app_skin; ?> sidebar-mini sidebar-collapse">
    <div class="wrapper">

    <?php include "fe_menus-dropdown.php"; ?>
    <?php include "fe_menus-sidebar.php"; ?>


      <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
      <?php include "fe_system/fe_core/fe_config_control.php"; ?>
            <!-- GANTI DARI SINI -->
