  ...
  <body class="hold-transition login-page" style="<?php echo $background;?>">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Reset Login (Silahkan Masukan Email)</p>
        <?php
            $token = bin2hex(openssl_random_pseudo_bytes(16));
            setcookie("CSRFtokenReset", $token, time() + 60 * 60 * 24);
        ?>        
        <form action="<?php echo uri_link('login-reset-process');?>" method="post">
          ...
          <div class="row">
           ...
           <div class="col-xs-12">
              <input name="CSRFtokenReset" type="hidden" value="<?php echo $token; ?>">
